...
public class AuthenticationServiceUnitTesting {
	...
	private Users createUser() {
		...
		Users user = new Users(1, "admin", "$2a$10$IoqonpxYeSWir9ir16Pb6.8sCa444mtsH6R6oH.ioWnHkpODsBsPS",
				"admin@gmail.com", "1234356788", true, role);
		return user;
	}
	...
	public void newSignUp() throws UserAlreadyExistException {
		LOGGER.info("Start");
		when(repository.findByUserName("rohith")).thenReturn(null);
		Users user = new Users(1, "rohith", "$2a$10$IoqonpxYeSWir9ir16Pb6.8sCa444mtsH6R6oH.ioWnHkpODsBsPS",
				"rohithnarjala@gmail.com", "7356490987", true);
		service.signup(user);
		LOGGER.info("End");
